...
namespace JARVIS
{
    ...
    class Calculations
    {
        ...
        {
            string simple = calc.Replace("calcule", ""); // remove o início da frase
            simple = calc.Replace("matemática", ""); // remove o início da frase
            simple = calc.Replace("quanto é", ""); // remove o início da frase
